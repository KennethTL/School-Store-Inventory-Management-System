...
?>
    <div class="container body">
      <?php require_once 'processsupplier.php'; ?>
 ...
 <?php
  ...
  <?php endif;  ?>
    ...
    <div class="row justify-content-center">
      ...
      while ($row = $result->fetch_assoc()): ?>
        ...
        <tr>
          ...
          <td>
            <a href="editsupplier.php?edit=<?php echo $row['supplier_id']; ?>" class ="btn btn-info"> Edit </a>
            <a href="processsupplier.php?delete=<?php echo $row['supplier_id']; ?>" class ="btn btn-danger"> Delete </a>
    ...
    <form action="processsupplier.php" method="POST">
      ...
      <input type="text" name="contact" class="form-control" value="<?php echo $contact; ?>" placeholder="Phone Number">
      </div>
      <div class="form-group">
      <label>Email Address</label>
      <input type="text" name="email" class="form-control" value="<?php echo $email; ?>" placeholder="Email Address">
      </div>
