...
?>
    <div class="container body">
      <?php require_once 'processlending.php'; ?>
 ...
 <?php
  ...
  <?php endif;  ?>
    ...
    <?php
      ...
      $result = $mysqli->query("SELECT * FROM lending WHERE visibility = 0") or die($mysqli->error);
    ...
    <div class="row justify-content-center">
      ...
      while ($row = $result->fetch_assoc()): ?>
        ...
        <tr>
          ...
          <td><?php echo $row['date_lended']; ?></td>
          <td><?php echo $row['date_return']; ?></td>
          <td><?php echo $row['status']; ?></td>
          <td>
            <a href="editrecords.php?edit=<?php echo $row['issue_id']; ?>" class ="btn btn-info"> Edit </a>
            <a href="processlending.php?delete=<?php echo $row['issue_id']; ?>" class ="btn btn-danger"> Delete </a>
    ...
    <div class="row justify-content-center">
    <form action="processlending.php" method="POST">
      <input type="hidden" name="id" value="<?php echo $id; ?>">
      <div class="form-group">
      <label>Inventory ID</label>
      <input type="text" name="inventoryid" class="form-control" value="<?php echo $inventoryid; ?>" placeholder="Inventory ID">
      </div>
      <div class="form-group">
      ...
      <input type="text" name="admissionno" class="form-control" value="<?php echo $admissionno; ?>" placeholder="Admission Number">
      </div>
      <div class="form-group">
      <label>Issue Date</label>
      <input type="text" name="datelended" class="form-control" value="<?php echo $datelended; ?>" placeholder="Issue Date">
      </div>
      <div class="form-group">
      <label>Date to return</label>
      <input type="text" name="datereturn" class="form-control" value="<?php echo $datereturn; ?>" placeholder="Date to return">
      </div>
      <div class="form-group">
      <label>Status</label>
      <input type="text" name="status" class="form-control" value="<?php echo $status; ?>" placeholder="Status">
      </div>
