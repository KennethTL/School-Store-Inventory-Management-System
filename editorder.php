 ...
 <?php
  ...
  <?php endif;  ?>
      ...
      while ($row = $result->fetch_assoc()): ?>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="processorder.php?delete=<?php echo $row['order_id']; ?>" class ="btn btn-danger"> Delete </a>
    ...
    <form action="processorder.php" method="POST">
      ...
      <input type="text" name="supplierid" class="form-control" value="<?php echo $supplierid; ?>" placeholder="Supplier ID">
      </div>
      <div class="form-group">
      <label>Requisition ID</label>
      <input type="text" name="requisitionid" class="form-control" value="<?php echo $requisitionid; ?>" placeholder="Requisition ID">
      </div>
      <div class="form-group">
      <label>Status</label>
