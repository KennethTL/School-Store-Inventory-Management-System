...
?>
    <div class="container body">
       <?php require_once 'processlost.php'; ?>
 ...
 <?php
  ...
  <?php endif;  ?>
    ...
    <?php
      ...
      $result = $mysqli->query("SELECT * FROM lost WHERE visibility=0") or die($mysqli->error);


    ?>


    <div class="row justify-content-center" id="tprint">
      <table class="table">
        <thead>
          <tr>
            <th>Issue ID</th>
      ...
      while ($row = $result->fetch_assoc()): ?>
        ...
        <tr>
          ...
          <td>
            <a href="editP.php?edit=<?php echo $row['penalty_id']; ?>" class ="btn btn-info"> Edit </a>
            <a href="processlost.php?delete=<?php echo $row['penalty_id']; ?>" class ="btn btn-danger"> Delete </a>
    ...
    <form action="processlost.php" method="POST">
      <input type="hidden" name="id" value="<?php echo $id; ?>">
      <div class="form-group">
      <label>Issue ID</label>
      <input type="text" name="issueid" class="form-control" value="<?php echo $issueid; ?>" placeholder="Issue ID">
      </div>
      <div class="form-group">
      ...
      <input type="text" name="admissionno" class="form-control" value="<?php echo $admissionno; ?>" placeholder="Admission No.">
      </div>
      <div class="form-group">
      <label>Penalty</label>
      <input type="text" name="penalty" class="form-control" value="<?php echo $penalty; ?>" placeholder="Penalty">
      </div>
      ...
      <?php endif; ?>
                  ...
                  <div class="row no-print">
                        <div class=" ">
                          <button class="btn btn-default" onclick="CallPrint(this.value);"><i class="fa fa-print"></i> Print</button>
                        </div>
                      </div>
                              <script>
                                      function CallPrint(strid) {
                                      var prtContent = document.getElementById("tprint");
                                      var WinPrint = window.open('', '', 'left=0,top=0,width=800,height=900,toolbar=0,scrollbar=0,status=0');
